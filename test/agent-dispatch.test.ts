...
describe("tool surface", () => {
  it("exposes exactly the expected tool names", () => {
    ...
    expect(names).toEqual(
      ["browse", "click", "compare", "compose", "convert_currency", "extract", "fetch_json", "find_nearby", "get_weather", "pdf", "read", "reply", "scrape", "screenshot", "search", "transcript", "type", "web_search"].sort()
    );
  });
