...
• Encode / decode / hash: "base64 encode X", "decode this base64 ...", "url-encode ...", "hex decode ...", "rot13 ...", "sha256 of X", "md5 of X", "hello in binary", "decode this JWT ..." → exact conversion, instantly (hashes are one-way; I read a JWT's payload but don't verify its signature).
